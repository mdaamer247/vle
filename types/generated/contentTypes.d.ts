...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recentInResourcePage: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiDigitalSecurityDigitalSecurity
  extends Struct.SingleTypeSchema {
  collectionName: 'digital_security_pages';
  info: {
    description: 'Digital Security landing page content';
    displayName: 'Digital Security Page';
    pluralName: 'digital-securities';
    singularName: 'digital-security';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    compatibilitySection: Schema.Attribute.Component<
      'shared.compatibility-section',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    pricingSection: Schema.Attribute.Component<'shared.pricing-section', false>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whiteGloveSection: Schema.Attribute.Component<
      'shared.white-glove-section',
      false
    >;
    whyMattersSection: Schema.Attribute.Component<
      'shared.why-matters-section',
      false
    >;
  };
}
...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual FAQ question and answer item';
...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently Asked Questions page content management';
  ...
  attributes: {
    contactSection: Schema.Attribute.Component<'shared.contact-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroSection: Schema.Attribute.Component<'shared.faq-hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global footer for all pages';
    displayName: 'Footer';
    pluralName: 'footers';
    singularName: 'footer';
  };
  ...
  attributes: {
    bottomSection: Schema.Attribute.Component<
      'shared.footer-bottom-section',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linkColumns: Schema.Attribute.Component<'shared.footer-link-column', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    > &
      Schema.Attribute.Private;
    middleSection: Schema.Attribute.Component<
      'shared.footer-middle-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global header for all pages';
    displayName: 'Header';
    pluralName: 'headers';
    singularName: 'header';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainNavigation: Schema.Attribute.Component<'shared.main-navigation', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    utilityBar: Schema.Attribute.Component<'shared.utility-bar', false>;
  };
}
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    digitalSecuritySection: Schema.Attribute.Component<
      'shared.digital-security-section',
      false
    >;
    globalConnectivitySection: Schema.Attribute.Component<
      'shared.global-connectivity-section',
      false
    >;
    heroSection: Schema.Attribute.Component<'shared.hero-section', false> &
      Schema.Attribute.Required;
    ...
    pricingSection: Schema.Attribute.Component<'shared.pricing-section', false>;
    publishedAt: Schema.Attribute.DateTime;
    savingsSection: Schema.Attribute.Component<'shared.savings-section', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    serviceFeaturesSection: Schema.Attribute.Component<
      'shared.service-features-section',
      false
    >;
...
export interface ApiResourcePageResourcePage extends Struct.SingleTypeSchema {
  collectionName: 'resource_pages';
  info: {
    description: 'Resource page content management';
  ...
  attributes: {
    ...
    featuredArticlesSection: Schema.Attribute.Component<
      'shared.featured-articles-section',
      false
    >;
    heroSection: Schema.Attribute.Component<
      'shared.resource-hero-section',
      false
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recentArticlesSection: Schema.Attribute.Component<
      'shared.recent-articles-section',
      false
    >;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::digital-security.digital-security': ApiDigitalSecurityDigitalSecurity;
